...
public class TablaM {
    ...
    public TablaM(producciones prod, Primero primeros, Siguiente siguientes) {
        this.tablaM = new HashMap<>();

        construirTablaM(prod);
    ...
    private void construirTablaM(producciones gSVicio) {
