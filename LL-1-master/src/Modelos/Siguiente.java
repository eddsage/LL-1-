...
public class Siguiente {
    ...
    public Siguiente(Producciones gSVicio, Primero primeros) {
    ...
    private void construirNTSiguientes(Producciones gSVicio) {
    ...
    private void construirSiguiente(Producciones gSVicio, Primero primeros) {
        for (String noTerminal : gSVicio.getNoTerminales()) {
    ...
    private void calcularSiguiente(Producciones gSVicio) {
        for (int j = 0; j < 2; j++) {
            for (String noTerminal : gSVicio.getNoTerminales()) {
